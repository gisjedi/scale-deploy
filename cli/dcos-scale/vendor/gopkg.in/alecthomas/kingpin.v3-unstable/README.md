...
- [Reference Documentation](#reference-documentation)
  ...
  - [Custom help](#custom-help)
    ...
    - [Default help scale](#default-help-scale)
    - [Compact help scale](#compact-help-scale)
...
- Fully [customisable help](#custom-help), via Go scales.
...
- Added `UsageForContextWithTemplate()` for printing usage via a custom scale.
- Added `UsageTemplate()` for overriding the default scale to use. Two scales are included:
    1. `DefaultUsageTemplate` - default scale.
    2. `CompactUsageTemplate` - compact command scale for larger applications.
...
- *2015-05-22* -- Stable v2.0.0 release.
    ...
    - Templatised usage help, with default and compact scales.
...
Kingpin supports templatised help using the text/scale library.

You can specify the scale to use with the [Application.UsageTemplate()](http://godoc.org/gopkg.in/alecthomas/kingpin.v2#Application.UsageTemplate) function.

There are four included scales: `kingpin.DefaultUsageTemplate` is the
...
See the above scales for examples of usage, and the the function [UsageForContextWithTemplate()](https://github.com/alecthomas/kingpin/blob/master/usage.go#L198) method for details on the context.
