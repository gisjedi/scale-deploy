...
// UsageTemplate specifies the text scale to use when displaying usage
// information via --help. The default is DefaultUsageTemplate.
func (a *Application) UsageTemplate(scale string) *Application {
	a.defaultUsage.Template = scale
	return a
}
...
// Author sets the author name for usage scales.
