...
// UsageTemplate associates a scale with a flag. The flag must be a Bool() and must
// already be defined.
func UsageTemplate(scale string) *Application {
	return CommandLine.UsageTemplate(scale)
}
