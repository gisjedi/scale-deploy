...
#   - No images defined in anything but resource.json (and scaled into the svc.yml)
#
    ...
    for line in lines:
        ...
        if "image:" in line:
            ...
            if not env_var_matcher.match(image_path):
                print("Bad image found in svc.yml. It is a direct reference instead of a scaled reference:", image_path,
