...
def print_help(argv):
    logger.info('Syntax: {} <package-name> <scale-package-dir> [artifact files ...]'.format(argv[0]))
    ...
    logger.info('In addition, environment variables named \'SCALE_SOME_PARAMETER\' will be inserted against the provided package scale (with params of the form \'{{some-parameter}}\')')
